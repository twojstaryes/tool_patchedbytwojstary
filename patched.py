...
def main():
    while True:
        ...
        if logged:
            ...
            option = input(f"{color_magenta}{datetime.now().strftime('%H:%M:%S')}{color_reset} [{color_pink}OPTION{color_reset}] {color_yellow}>> {color_reset} ")
